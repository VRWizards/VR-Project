...
public class FindCollision : NetworkBehaviour {
...
//		InvokeRepeating("CmdShotTimer",0,.1f);
	//	lefty = frame.;
...
//	void CmdShotTimer()
//	{
//		if (shooting && Network.isClient == true) {
...
//	[Command]
//	void CmdOnConnectedToServer()
//	{
//		NetworkInstantiate.playerList.Add(this);
//	}
//
